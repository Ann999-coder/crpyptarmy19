...
class MajorSecretInformationSendClass:
...
# ---------------------------------------------------------------------------------------------------------
    ...
    def sendaction(self):
        ...
        sql = "insert into sendinfo(senderid,recieverid)VALUES(%s,%s)"
        adr = (send_id, self.rec_id)
        mycursor.execute(sql, adr)
...
#cp = MajorSecretInformationSendClass(root)
#root.mainloop()
