...
class OtpPasswordClass:
    ...
    def __init__(self, master):
        ...
        master.title("Password Change")
        master.configure(bg="white")

        self.email = Label(master, text="Enter The OTP", font=("times new roman", 15, "bold"),bg="white").place(x=30, y=30)

        self.password = Label(master, text="New Password", font=("times new roman", 15, "bold"),bg="white").place(x=30, y=100)

        self.rpassword = Label(master, text="ReType Password", font=("times new roman", 15, "bold"),bg="white").place(x=30, y=170)
