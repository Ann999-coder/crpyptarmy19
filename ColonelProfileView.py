...
#ColonelProfileViewClass

import mysql.connector

import foo

class ColonelProfileViewClass:
    def __init__(self, top):
        ...
        top.title("Colonel Profile View")
        userid = Label(top, text="Enter ID", font=("times new roman", 15, "bold")).place(x=10, y=30)
        password = Label(top, text="Date Of Birth", font=("times new roman", 15, "bold"),).place(x=10, y=80)
        name = Label(top, text="Name", font=("times new roman", 15, "bold"),).place(x=10, y=130)
        gender = Label(top, text="Gender", font=("times new roman", 15, "bold")).place(x=10, y=180)

        designation = Label(top, text="Designation",  font=("times new roman", 15, "bold")).place(x=10, y=230)

        address = Label(top, text="Address", font=("times new roman", 15, "bold")).place(x=10, y=280)
        city = Label(top, text="City",font=("times new roman", 15, "bold")).place(x=10, y=330)
        pin = Label(top, text="Pin", font=("times new roman", 15, "bold")).place(x=10, y=380)
...
#top=Tk()
#cp= ColonelProfileViewClass(top)
