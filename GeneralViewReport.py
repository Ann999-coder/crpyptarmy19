...
class GeneralViewReportClass:
    def __init__(self, top):
        ...
        top.title("General View Secret Info")
    ...
    def select_Combo(self, event):
        ...
        sql = "select distinct senderid from sendinfo where senderid in(select userid from login where usertype=%s and userid!=%s)"
