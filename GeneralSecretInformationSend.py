...
class GeneralSecretInformationSendClass:
    ...
    def __init__(self, top):
        ...
        top.title("General Information Passing")

        sender = Label(top, text="Rank", font=("times new roman", 15, "bold")).place(x=10, y=20)
#---------------------------------------------------------------------------------------------------------
...
#cp = GeneralSecretInformationSendClass(root)
#root.mainloop()
