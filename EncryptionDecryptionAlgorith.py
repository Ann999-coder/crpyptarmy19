...
def decrypt_image(path):
    ...
    #cv2.imshow("image", img_matrix)
    cv2.imwrite("dencrypted.png", img_matrix)
    #cv2.waitKey()
encrypt_image("E:/MyPyCharmProjects/FirstProject/first.png")
check="E:/MyPyCharmProjects/FirstProject/encrypted.png"
print("path check is",check)
decrypt_image("E:/MyPyCharmProjects/FirstProject/encrypted.png")
